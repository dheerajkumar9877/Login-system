        ...
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-gray-300 px-4 py-3 pr-14 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-xl transition duration-300 disabled:bg-gray-400"
          >
